...
public class PrivateKeyReader {
    ...
    public static void main(String[] args) throws IOException, GeneralSecurityException {
        PrivateKeyReader privateKeyReader = new PrivateKeyReader("D:\\work_project\\MyGrpcDemo\\src\\main\\java\\com\\tj\\auth\\private.pem");
        PrivateKey privateKey = privateKeyReader.getPrivateKey();
    ...
    public PrivateKey getPrivateKey() throws IOException, GeneralSecurityException {
        ...
        try {
            ...
            // byte[] encoded = Hex.decodeHex(builder.toString().toCharArray());
            if (isRSAKey) {
